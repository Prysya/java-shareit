...
public interface BookingService {
    ...
    List<BookingResponseDto> getCurrentUserBookings(BookingState state, long itemId);

    List<BookingResponseDto> getCurrentUserAllItemsBookings(BookingState state, long itemId);
}
